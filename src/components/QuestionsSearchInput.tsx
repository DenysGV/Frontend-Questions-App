...
const QuestionsSearchInput = () => {
   return (
      <div className="relative">
         <input className="border-0 rounded-3xl bg-indigo-400 py-2 px-4 text-sm text-white w-full focus:outline-0 " type="text" placeholder="Питання або номер" name="text" />
