...
const QuestionsMainBottom = ({ next, prev }: { next: MouseEventHandler<HTMLDivElement>, prev: MouseEventHandler<HTMLDivElement> }) => {
   return (
      <div className="flex justify-between">
         <Badge isBig={true} pointer={true} clickHandler={prev}>
         ...
         <Badge isBig={true} pointer={true} clickHandler={next}>
            Наступне
            <svg width="12" height="28" viewBox="0 0 12 20" fill="none" xmlns="http://www.w3.org/2000/svg">
